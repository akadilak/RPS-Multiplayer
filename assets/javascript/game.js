$(document).on('ready', function() {
    ...
    // Links to Firebase
    var database = new Firebase("https://rock-paper-scissors-multiplay.firebaseio.com/");
    var presenceRef = new Firebase('https://rock-paper-scissors-multiplay.firebaseio.com/.info/connected');
    var playersRef = new Firebase('https://rock-paper-scissors-multiplay.firebaseio.com/playersRef');
    var turnRef = new Firebase('https://rock-paper-scissors-multiplay.firebaseio.com/turn');
    var chatRef = new Firebase('https://rock-paper-scissors-multiplay.firebaseio.com/chat');
